            ...
            <div className='bg-slate-400  rounded flex flex-col items-center gap-5 overflow-y-auto overflow-y-auto'>
                ...
                <form >
                    ...
                    <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div className="sm:col-span-2">
                            <form action='http://localhost:5001/api/clients/savePdfs' encType='multipart/form-data' method='post'>
                                <input type="file" name='IMG_0421' id='archive' multiple={true} />
                                <input 
                                className=" block text-black bg-blue-300 hover:bg-blue-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-300 dark:hover:bg-blue-400 dark:focus:ring-blue-400"
                                type="submit" 
                                value="Cargar" />
                            </form>
                        </div>
